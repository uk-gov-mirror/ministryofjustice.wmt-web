module.exports = {
  ...
  NEW_ARCHIVE_DATABASE_START_DATE: process.env.WMT_NEW_ARCHIVE_DATABASE_START_DATE || '26/08/2016',

  NEW_DATABASE_START_DATE: process.env.WMT_NEW_DATABASE_START_DATE || '06/04/2020',
