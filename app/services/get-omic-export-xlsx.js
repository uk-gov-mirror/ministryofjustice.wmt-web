...
const caseHeaders = require('../constants/omic-excel-headings').caseHeaders
const nameHeaders = require('../constants/omic-excel-headings').nameHeaders
const reportHeaders = require('../constants/omic-excel-headings').reportHeaders
const caseTypeHeaders = require('../constants/omic-excel-headings').caseTypeHeaders
const inputScenarioCaseData = require('./excel/input-omic-scenario-case-data')
