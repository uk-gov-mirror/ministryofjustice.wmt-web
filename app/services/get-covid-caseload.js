...
const getCaseload = require('./data/get-covid-caseload')
const getOrganisationUnit = require('./helpers/org-unit-finder')
const caseloadHelper = require('./helpers/covid-caseload-helper')
...
var replaceIncorrectPercentageAverages = function (originalPercentageTotals, correctPercentages) {
  ...
  keys.forEach(function (key) {
    originalPercentageTotals[key].doorstop = correctPercentages[key].doorstop
    originalPercentageTotals[key].contactCentre = correctPercentages[key].contactCentre
    originalPercentageTotals[key].phoneCall = correctPercentages[key].phoneCall
