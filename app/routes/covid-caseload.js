...
const getCaseload = require('../services/get-covid-caseload')
...
const caseloadTotaller = require('../helpers/covid-caseload-totaller')
const renderWMTUpdatingPage = require('../helpers/render-wmt-updating-page')
var lastUpdated

module.exports = function (router) {
  router.get('/' + workloadTypes.PROBATION + '/:organisationLevel/:id/covid-caseload', function (req, res, next) {
    try {
    ...
    return getLastUpdated().then(function (result) {
      ...
      .then(function (result) {
        ...
        return res.render('covid-caseload', {
          screen: 'caseload',
  ...
  router.get('/' + workloadTypes.PROBATION + '/:organisationLevel/:id/covid-caseload/caseload-csv', function (req, res, next) {
    try {
      authorisation.assertUserAuthenticated(req)
    } catch (error) {
      if (error instanceof Unauthorized) {
