...
const getRegionWorkloadReports = require('../services/data/get-workload-reports-views')
...
module.exports = function (router) {
  router.get('/region/:id', function (req, res, next) {
    ...
    var lduWorkloadReportsPromise = getRegionWorkloadReports(req.params.id, capacityDateRange, CapacityTypes.LDU)
