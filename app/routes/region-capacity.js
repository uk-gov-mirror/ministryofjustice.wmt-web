...
const getRegionCapacity = require('../services/data/get-capacity-views')
...
module.exports = function (router) {
  router.get('/region/:id', function (req, res, next) {
    ...
    var capacityPromise = getRegionCapacity(req.params.id, capacityDateRange, CapacityTypes.REGION)
