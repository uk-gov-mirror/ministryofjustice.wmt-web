...
const NON_OM_URL = '/team/1/overview'
...
describe('case-progress route', function () {
  ...
  it('should respond with 500 when a level other than offender manager is called', function () {
    getOverview.resolves(OVERVIEW)
    return supertest(app).get(NON_OM_URL).expect(500)
  })
