...
describe('View reductions export for a Data Admin', function () {
  ...
  it('should include the reductions export for data admin users at team level', function () {
  ...
  it('should include the reductions export for data admin users at ldu level', function () {
    return browser.url(lduDefaultUrl + '/overview')
      .isExisting('.reduction-export').then(function (exist) {
        expect(exist).to.be.true //eslint-disable-line
      })
  })
  it('should include the reductions export for data admin users at region level', function () {
    return browser.url(lduDefaultUrl + '/overview')
      .isExisting('.reduction-export').then(function (exist) {
        expect(exist).to.be.true //eslint-disable-line
      })
  })
  it('should not include the reductions export for data admin users at workload owner level', function () {
    return browser.url(workloadOwnerDefaultUrl + '/overview')
      .isExisting('.reduction-export').then(function (exist) {
        expect(exist).to.be.false //eslint-disable-line
      })
  })
  it('should not include the reductions export for data admin users at national level', function () {
