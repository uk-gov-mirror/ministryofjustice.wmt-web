...
describe('services/data/get-capacity-for-individual', function () {
  ...
  it('should retrieve all the workloads within the date range', function () {
    return getWorkloadReportsForIndividual(inserts.filter((item) => item.table === 'workload_owner')[0].id, startDate, endDate)
