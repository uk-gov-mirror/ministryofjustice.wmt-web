...
describe('services/data/get-court-reports-overview', function () {
  ...
  it('should retrieve data for all workload_owners in a team', function () {
    ...
    .then(function (results) {
      ...
      expect(results[0].totalCasesSdrs).to.be.eql(12)
      expect(results[0].totalCasesFdrs).to.be.eql(13)
      expect(results[0].totalCasesOralReports).to.be.eql(14)
    })
  })
  ...
  it('should retrieve data for all workload_owners in a ldu', function () {
    ...
    .then(function (results) {
      ...
      expect(results[0].totalCasesSdrs).to.be.eql(24)
      expect(results[0].totalCasesFdrs).to.be.eql(26)
      expect(results[0].totalCasesOralReports).to.be.eql(28)
    })
  })
